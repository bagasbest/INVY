...
class WarehouseProductInActivity : AppCompatActivity() {
    ...
    private fun formValidation() {
        ...
        val productColor = binding?.productColor?.text.toString().trim()

        if(date == "Date") {
            Toast.makeText(this, "Tanggal Barang Masuk tidak boleh kosong", Toast.LENGTH_SHORT).show()
        } else if (name.isEmpty()) {
            Toast.makeText(this, "Nama Barang Masuk tidak boleh kosong", Toast.LENGTH_SHORT).show()
        } else if (total.isEmpty()) {
            Toast.makeText(this, "Total Barang Masuk tidak boleh kosong", Toast.LENGTH_SHORT).show()
        } else if (productVendor.isEmpty()) {
            Toast.makeText(this, "Nama Vendor Barang Masuk tidak boleh kosong", Toast.LENGTH_SHORT).show()
        } else if (productColor.isEmpty()) {
            Toast.makeText(this, "Warna Barang Masuk tidak boleh kosong", Toast.LENGTH_SHORT).show()
        } else if (dp == null) {
            Toast.makeText(this, "Bukti Penerimaan Barang Masuk tidak boleh kosong", Toast.LENGTH_SHORT).show()
        } else {
    ...
    /// tampilkan dialog box ketika gagal menambahkan barang masuk
    private fun showFailureDialog() {
        AlertDialog.Builder(this)
            .setTitle("Gagal")
            .setMessage("Gagal menambahkan penerimaan barang masuk, silahkan periksa koneksi internet anda, dan coba lagi nanti")
    ...
    /// tampilkan dialog box ketika sukses menambahkan barang masuk
    private fun showSuccessDialog() {
        AlertDialog.Builder(this)
            .setTitle("Berhasil")
            .setMessage("Sukses menambahkan penerimaan barang masuk, admin akan mengeceknya.")
    ...
    private fun uploadArticleDp(data: Uri?) {
        ...
        val imageFileName = "product_in/image_" + System.currentTimeMillis() + ".png"
